...
import {
  useParams, useNavigate, useMatch, BrowserRouter as Router,
  Routes, Route, Link
...
const CreateNew = (props) => {
  ...
  const { reset: resetContent, ...inputPropsContent } = content
  const { reset: resetAuthor, ...inputPropsAuthor } = author
  const { reset: resetInformation, ...inputPropsInfo } = info
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <div>
          content
          <input {...inputPropsContent} />
        </div>
        <div>
          author
          <input {...inputPropsAuthor} />
        </div>
        <div>
          url for more info
          <input {...inputPropsInfo} />
        </div>
